...
- **If the skill you're editing has `model_spec.json` / `host_adapter.py` alongside its SKILL.md (a generative skill), use `update-generative-skill` instead** — it covers the re-download and coordinator-restart follow-up.
