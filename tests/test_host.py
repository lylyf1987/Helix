...
if __name__ == "__main__":
    ...
    print("\n=== Streaming ===")
    test_streaming_extractor_partial_no_action_yet()
    test_streaming_extractor_after_action()
    test_streaming_extractor_holdback_prevents_partial_leak()
    test_streaming_extractor_too_short()
    test_streaming_display_on_reasoning_emits_dim_prefix()
    test_streaming_display_content_after_reasoning_closes_dim()
    test_streaming_display_retry_cue_on_discard()
    test_streaming_display_commit_closes_dim_if_active()
    test_streaming_display_discard_closes_dim_if_active()
    test_streaming_display_reset_closes_dim_if_active()
